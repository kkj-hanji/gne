...
test("service worker caches only an unused response copy and absorbs cache-write failures", () => {
  ...
  assert.match(appSource, /serviceWorker\.register\("\/sw\.js\?v=20260901-1"/);
});
