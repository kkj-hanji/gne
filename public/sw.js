...
const CACHE_NAME = `${CACHE_PREFIX}20260925-5`;
const SHELL = [
  "/",
  "/exam-domain.js?v=20260925-5",
  "/exam-desk.js?v=20260925-5",
  "/exam-import.js?v=20260925-5",
  "/admin-exams.js?v=20260925-5",
  "/data/exam-summary.json",
  "/index.html",
  "/styles.css?v=20260925-5",
