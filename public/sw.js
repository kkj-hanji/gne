...
const CACHE_NAME = `${CACHE_PREFIX}20260925-4`;
const SHELL = [
  "/",
  "/exam-domain.js?v=20260925-4",
  "/exam-desk.js?v=20260925-4",
  "/exam-import.js?v=20260925-4",
  "/admin-exams.js?v=20260925-4",
  "/data/exam-summary.json",
  "/index.html",
  "/styles.css?v=20260925-4",
